...
.flat:hover { background: rgba(127, 0, 127, 0.5); }
...
.lxinked button               {background-color: rgba(127, 127, 127, 0.15); border: solid 1px rgba(127, 127, 127, 0.00); box-shadow: 0px 0px 0px 0px rgba(255,0,0,0.15);}
.linked button               {background: @theme_bg_color; border: 1px solid rgba(0, 0, 0, 0.1); box-shadow: 0 4px 20px rgba(127, 127, 127, 0.18);}
.linked button:hover         {background: @theme_bg_color); border: solid 5px rgba(127, 127, 127, 0.30);}
.linked button:active        {background: rgba(127, 127, 127, 0.35); border: solid 1px rgba(127, 127, 127, 0.00);}
.linked button:checked       {background: rgba(127, 127, 127, 0.35); border: solid 1px rgba(127, 127, 127, 0.00);}
.linked button:checked:hover {background: rgba(127, 127, 127, 0.35); border: solid 1px rgba(127, 127, 127, 0.30);}
.linked button:first-child:hover {background-color: rgba(127, 127, 127, 0.35); border: solid 1px rgba(127, 127, 127, 0.30);}
.linked button:hover:not(:first-child):not(:last-child) {background-color: rgba(127, 127, 127, 0.35); border: solid 1px rgba(127, 127, 127, 0.30);margin-right: 1px;}
...
.linked menubutton button {
    background-color: @theme_bg_color; border: solid 1px rgba(127, 127, 127, 0.30); 
}
...
.linked splitbutton:first-child > menubutton > button.toggle   {
    ...
    border-right: solid 1px rgba(127, 127, 127, 0.00);

    }
.linked splitbutton:first-child > menubutton > button.toggle:hover   {
    border-top-left-radius: 0px; border-bottom-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px;
    border: solid 1px rgba(127, 127, 127, 0.30);
    margin-right: 1px;
...
.linked splitbutton:last-child > button  {
    border-top-left-radius: 0px; border-bottom-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-right: solid 1px rgba(127, 0, 0, 0.00);}    
...
"""
    ...
    def setup_headerbar_content(self, win):
        ...
        file_toolbar_toggle.add_css_class("toolbar-group")
...
#### Zoom statusbar
    def on_zoom_changed_statusbar(self, win, scale):
        ...
        win.zoom_level = zoom_level
        win.statusbar.set_text(f"Zoom: {zoom_level}%")
        # Apply zoom to the editor
        self.apply_zoom(win, zoom_level)
        win.webview.grab_focus()
