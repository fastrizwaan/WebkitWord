...
"""
    ...
    def setup_headerbar_content(self, win):
        ...
        # Add edit group to headerbar (still on the left side, after file group)
        win.headerbar.pack_start(edit_group)
        ...
        undo_redo_group.set_margin_end(2)
        ...
        print_find_group.set_margin_end(2)
        ...
        # Add buttons to print/find group
        ...
        # Add print/find group to headerbar
        win.headerbar.pack_end(print_find_group)        
        # Add undo group to headerbar
        win.headerbar.pack_end(undo_redo_group)
...
#
    def setup_menu_button(self, win):
        ...
        # Create a menu button with an arrow icon
        menu_button = Gtk.MenuButton()
        menu_button.set_icon_name("view-more-horizontal-symbolic")  # Right arrow icon
        menu_button.set_tooltip_text("Show Actions Menu")
        #menu_button.add_css_class("linked")
        ...
        file_grid = Gtk.Grid()
        file_grid.set_column_spacing(2)
        file_grid.set_row_spacing(2)
        ...
        file_grid.attach(new_button, 0, 0, 1, 1)
        ...
        file_grid.attach(open_button, 0, 1, 1, 1)
        ...
        file_grid.attach(save_button, 0, 2, 1, 1)
        
        # Save As button
        save_as_button = Gtk.Button(label="Save As")
        save_as_button.set_icon_name("document-save-as-symbolic")
        save_as_button.connect("clicked", lambda btn: self.on_save_as_clicked(win, btn))
        save_as_button.set_hexpand(True)
        file_grid.attach(save_as_button, 0, 3, 1, 1)
        
        popover_box.append(file_grid)
