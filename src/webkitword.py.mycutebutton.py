...
.mycutebutton:hover {
  background: #f8f8f8;
  box-shadow: 0 33px 12px rgba(0, 0, 0, 0.2);
...
.linked button               {background-color: rgba(127, 127, 127, 0.15); border: solid 1px rgba(127, 127, 127, 0.00); box-shadow: 0px 0px 0px 0px rgba(255,0,0,0.15);}
...
.linked menubutton button {
    background-color: @theme_bg_color; border: solid px rgba(127, 127, 127, 0.80); 
}
...
##############
    ...
    def add_subscript_superscript_controls(self, win):
        ...
        subscript_group = Gtk.Box(css_classes=["mycutebutton"], orientation=Gtk.Orientation.HORIZONTAL, spacing=0)
        ...
        if hasattr(self, 'on_superscript_toggled'):
            ...
            #win.superscript_button.add_css_class("mycutebutton")
