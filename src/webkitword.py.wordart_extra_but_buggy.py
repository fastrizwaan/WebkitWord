...
########### /ltr rtl direction
    ...
    def on_wordart_clicked(self, win, btn):
        ...
        text_entry = Gtk.Entry()
        text_entry.set_placeholder_text("Enter text for Word Art or leave empty to use selected text")
        ...
        # Define Word Art styles - updated with all styles from the first code snippet
        word_art_styles = [
            ...
            {"id": "gold", "name": "Gold", "preview": "Gold"},
            {"id": "ice", "name": "Ice", "preview": "Ice"},
            {"id": "neon-pink", "name": "Neon Pink", "preview": "Pink"},
            {"id": "stone", "name": "Stone", "preview": "Stone"},
            {"id": "plasma", "name": "Plasma", "preview": "Plasma"},
            {"id": "vintage", "name": "Vintage", "preview": "Vintage"},
            {"id": "laser", "name": "Laser", "preview": "Laser"},
            {"id": "bubble", "name": "Bubble", "preview": "Bubble"},
            {"id": "electric", "name": "Electric", "preview": "Electric"},
            # New styles that look great on white backgrounds
            {"id": "bold-blue", "name": "Bold Blue", "preview": "Bold Blue"},
            {"id": "royal-purple", "name": "Royal Purple", "preview": "Royal"},
            {"id": "deep-red", "name": "Deep Red", "preview": "Deep Red"},
            {"id": "forest-green", "name": "Forest Green", "preview": "Forest"},
            {"id": "copper", "name": "Copper", "preview": "Copper"},
            {"id": "navy-shadow", "name": "Navy Shadow", "preview": "Navy"},
            {"id": "burgundy", "name": "Burgundy", "preview": "Burgundy"},
            {"id": "teal-glow", "name": "Teal Glow", "preview": "Teal"},
            {"id": "chocolate", "name": "Chocolate", "preview": "Chocolate"},
            {"id": "steel-blue", "name": "Steel Blue", "preview": "Steel"},
            {"id": "crimson", "name": "Crimson", "preview": "Crimson"},
            {"id": "emerald", "name": "Emerald", "preview": "Emerald"},
            {"id": "bronze", "name": "Bronze", "preview": "Bronze"},
            {"id": "indigo", "name": "Indigo", "preview": "Indigo"},
            {"id": "maroon", "name": "Maroon", "preview": "Maroon"},
            {"id": "olive", "name": "Olive", "preview": "Olive"},
            {"id": "slate", "name": "Slate", "preview": "Slate"},
            {"id": "rust", "name": "Rust", "preview": "Rust"},
        ]
        
        # Generate CSS styles for previews - updated with all styles
        styles_css = """
        .wordart-shadow { 
        ...
        .wordart-ice {
            color: #87ceeb;
            text-shadow: 0 0 10px #87ceeb, 0 0 20px #87ceeb, 2px 2px 0px #4682b4;
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-neon-pink {
        ...
        .wordart-stone {
            color: #8b7355;
            text-shadow: 1px 1px 0px #a0522d, 2px 2px 0px #8b4513, 3px 3px 0px #654321, 4px 4px 8px rgba(0,0,0,0.6);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-plasma {
        ...
        .wordart-vintage {
            color: #8b4513;
            text-shadow: 2px 2px 0px #daa520, 4px 4px 0px #cd853f, 6px 6px 10px rgba(0,0,0,0.4);
            font-family: serif;
            font-weight: bold; 
            font-size: 16px;
        }
        ...
        .wordart-bubble {
            color: #87ceeb;
            text-shadow: -1px -1px 0 #4682b4, 1px -1px 0 #4682b4, -1px 1px 0 #4682b4, 1px 1px 0 #4682b4;
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-electric {
            color: #ffff00;
            text-shadow: 0 0 5px #ffff00, 0 0 10px #ffff00, 2px 2px 0px #ffa500, 4px 4px 0px #ff4500;
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-bold-blue {
        ...
        .wordart-royal-purple {
            color: #6b21a8;
            text-shadow: 2px 2px 6px rgba(107, 33, 168, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-deep-red {
        ...
        .wordart-forest-green {
            color: #166534;
            text-shadow: 2px 2px 4px rgba(22, 101, 52, 0.3);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-copper {
            color: #b45309;
            text-shadow: 1px 1px 2px rgba(180, 83, 9, 0.4), 2px 2px 4px rgba(180, 83, 9, 0.2);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-navy-shadow {
            color: #1e40af;
            text-shadow: 3px 3px 6px rgba(30, 64, 175, 0.5);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-burgundy {
            color: #991b1b;
            text-shadow: 2px 2px 4px rgba(153, 27, 27, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-teal-glow {
            color: #0f766e;
            text-shadow: 0 0 8px rgba(15, 118, 110, 0.6), 2px 2px 4px rgba(15, 118, 110, 0.3);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-chocolate {
            color: #92400e;
            text-shadow: 2px 2px 4px rgba(146, 64, 14, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-steel-blue {
            color: #0369a1;
            text-shadow: 2px 2px 5px rgba(3, 105, 161, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-crimson {
            color: #be123c;
            text-shadow: 2px 2px 4px rgba(190, 18, 60, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-emerald {
            color: #047857;
            text-shadow: 2px 2px 4px rgba(4, 120, 87, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-bronze {
            color: #a16207;
            text-shadow: 1px 1px 2px rgba(161, 98, 7, 0.4), 2px 2px 4px rgba(161, 98, 7, 0.2);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-indigo {
            color: #4338ca;
            text-shadow: 2px 2px 5px rgba(67, 56, 202, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-maroon {
            color: #881337;
            text-shadow: 2px 2px 4px rgba(136, 19, 55, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-olive {
            color: #365314;
            text-shadow: 2px 2px 4px rgba(54, 83, 20, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-slate {
            color: #334155;
            text-shadow: 2px 2px 4px rgba(51, 65, 85, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        .wordart-rust {
            color: #c2410c;
            text-shadow: 2px 2px 4px rgba(194, 65, 12, 0.4);
            font-weight: bold; 
            font-size: 16px;
        }
        """
        ...
        # Add styles to the grid (5 columns to fit more styles)
        for i, style in enumerate(word_art_styles):
            ...
            name_label.set_markup(f"<small>{style['name']}</small>")
            ...
            (function() {{
                ...
                switch ('{style_id}') {{
                    case 'shadow':
                        ...
                        break;
                    case 'outline':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 1px;"><span style="display: inline-block; color: white; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'inset':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; background-color: #666; color: transparent; text-shadow: 2px 2px 3px rgba(255,255,255,0.5); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'neon':
                    ...
                    case 'gradient-sunset':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to right, #ff4500, #ff8c00, #ffd700); -webkit-background-clip: text; background-clip: text; color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gradient-ocean':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to right, #00ced1, #4682b4, #00008b); -webkit-background-clip: text; background-clip: text; color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gradient-candy':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to right, #ff69b4, #9370db, #00b7eb); -webkit-background-clip: text; background-clip: text; color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;                                              
                    case 'fire':
                        ...
                        break;
                    case 'fire-blue':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(0deg, #00f, #00b7eb); -webkit-background-clip: text; background-clip: text; color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'fire-green':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(0deg, #006400, #00ff7f); -webkit-background-clip: text; background-clip: text; color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'fire-purple':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(0deg, #800080, #ff00ff); -webkit-background-clip: text; background-clip: text; color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'comic':
                    ...
                    case 'glitch':
                        ...
                        break;
                    case 'rainbow':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(45deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3); -webkit-background-clip: text; background-clip: text; color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'chrome':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #eee 0%, #999 50%, #777 51%, #555 100%); -webkit-background-clip: text; background-clip: text; color: transparent; -webkit-text-stroke: 1px #333; text-stroke: 1px #333; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'xgold':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #fff8dc 0%, #ffd700 15%, #ffcc00 35%, #daa520 65%, #b8860b 85%, #8b6914 100%); -webkit-background-clip: text; background-clip: text; color: transparent; text-shadow: 2px 2px 4px rgba(0,0,0,0.1); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'soft-emboss':
                    wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: #aaaaaa; -webkit-background-clip: text; background-clip: text; color: #ffffff; text-shadow: 2px 8px 6px rgba(0,0,0,0.2), 0px -5px 35px rgba(255,255,255,0.3); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                    break;
                    case 'gold':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: #aaaaaa; -webkit-background-clip: text; background-clip: text; color: #efefef; text-shadow: 2px 8px 6px rgba(0,0,0,0.2), 0px -5px 35px rgba(255,255,255,0.3); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;                    
                    case 'mark-dotto':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: #aaaaaa; -webkit-background-clip: text; background-clip: text; color: white; text-shadow: 0 1px 0 #ccc, 0 2px 0 #c9c9c9, 0 3px 0 #bbb, 0 4px 0 #b9b9b9, 0 5px 0 #aaa, 0 6px 1px rgba(0,0,0,.1), 0 0 5px rgba(0,0,0,.1), 0 1px 3px rgba(0,0,0,.3), 0 3px 5px rgba(0,0,0,.2), 0 5px 10px rgba(0,0,0,.25), 0 10px 10px rgba(0,0,0,.2), 0 20px 20px rgba(0,0,0,.15); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gordon-hall':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background-color: #666666; -webkit-background-clip: text; -moz-background-clip: text; background-clip: text; color: transparent; text-shadow: rgba(255,255,255,0.3) 0px 3px 3px; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'ice':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #87ceeb; text-shadow: 0 0 10px #87ceeb, 0 0 20px #87ceeb, 0 0 30px #87ceeb, 2px 2px 0px #4682b4; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'neon-pink':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff1493; text-shadow: 0 0 5px #ff1493, 0 0 10px #ff1493, 0 0 15px #ff1493, 0 0 20px #ff1493, 0 0 35px #ff1493, 0 0 40px #ff1493; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'stone':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #8b7355; text-shadow: 1px 1px 0px #a0522d, 2px 2px 0px #8b4513, 3px 3px 0px #654321, 4px 4px 8px rgba(0,0,0,0.6); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'plasma':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: radial-gradient(circle, #ff00ff 0%, #00ffff 25%, #ff00ff 50%, #00ffff 75%, #ff00ff 100%); -webkit-background-clip: text; background-clip: text; color: transparent; text-shadow: 0 0 10px #ff00ff; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'vintage':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #8b4513; text-shadow: 2px 2px 0px #daa520, 4px 4px 0px #cd853f, 6px 6px 10px rgba(0,0,0,0.4); font-family: serif; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'laser':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #00ff00; text-shadow: 0 0 5px #00ff00, 0 0 10px #00ff00, 0 0 15px #00ff00, 0 0 20px #00ff00, 0 0 25px #00ff00; font-family: monospace; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'bubble':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #87ceeb; -webkit-text-stroke: 2px #4682b4; text-stroke: 2px #4682b4; text-shadow: inset 0 0 10px rgba(255,255,255,0.8); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'electric':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ffff00; text-shadow: 0 0 5px #ffff00, 0 0 10px #ffff00, 0 0 15px #ffff00, 0 0 20px #ffff00, 2px 2px 0px #ffa500, 4px 4px 0px #ff4500; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'bold-blue':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #1e3a8a; text-shadow: 2px 2px 4px rgba(30, 58, 138, 0.3); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'royal-purple':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #6b21a8; text-shadow: 2px 2px 6px rgba(107, 33, 168, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'deep-red':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #dc2626; text-shadow: 2px 2px 4px rgba(220, 38, 38, 0.3); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'forest-green':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #166534; text-shadow: 2px 2px 4px rgba(22, 101, 52, 0.3); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'copper':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #b45309; text-shadow: 1px 1px 2px rgba(180, 83, 9, 0.4), 2px 2px 4px rgba(180, 83, 9, 0.2); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'navy-shadow':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #1e40af; text-shadow: 3px 3px 6px rgba(30, 64, 175, 0.5); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'burgundy':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #991b1b; text-shadow: 2px 2px 4px rgba(153, 27, 27, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'teal-glow':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #0f766e; text-shadow: 0 0 8px rgba(15, 118, 110, 0.6), 2px 2px 4px rgba(15, 118, 110, 0.3); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'chocolate':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #92400e; text-shadow: 2px 2px 4px rgba(146, 64, 14, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'steel-blue':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #0369a1; text-shadow: 2px 2px 5px rgba(3, 105, 161, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'crimson':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #be123c; text-shadow: 2px 2px 4px rgba(190, 18, 60, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'emerald':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #047857; text-shadow: 2px 2px 4px rgba(4, 120, 87, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'bronze':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #a16207; text-shadow: 1px 1px 2px rgba(161, 98, 7, 0.4), 2px 2px 4px rgba(161, 98, 7, 0.2); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'indigo':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #4338ca; text-shadow: 2px 2px 5px rgba(67, 56, 202, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'maroon':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #881337; text-shadow: 2px 2px 4px rgba(136, 19, 55, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'olive':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #365314; text-shadow: 2px 2px 4px rgba(54, 83, 20, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'slate':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #334155; text-shadow: 2px 2px 4px rgba(51, 65, 85, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'rust':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #c2410c; text-shadow: 2px 2px 4px rgba(194, 65, 12, 0.4); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;                        
                    default:
...
######################
    def on_wordart_clicked(self, win, btn):
        ...
        word_art_styles = [
            ...
            {"id": "rust", "name": "Rust", "preview": "Rust"},
            {"id": "outline", "name": "Outline", "preview": "Outline"},
            {"id": "outline-bold", "name": "Bold Outline", "preview": "Bold Outline"},
            {"id": "outline-double", "name": "Double Outline", "preview": "Double Outline"},
            {"id": "outline-neon", "name": "Neon Outline", "preview": "Neon Outline"},
            {"id": "inset", "name": "Inset", "preview": "Inset"},
            {"id": "inset-soft", "name": "Soft Inset", "preview": "Soft Inset"},
            {"id": "inset-deep", "name": "Deep Inset", "preview": "Deep Inset"},
            {"id": "inset-glow", "name": "Glowing Inset", "preview": "Glow Inset"},
            {"id": "neon", "name": "Neon Glow", "preview": "Neon"},
            {"id": "neon-blue", "name": "Blue Neon", "preview": "Blue Neon"},
            {"id": "neon-green", "name": "Green Neon", "preview": "Green Neon"},
            {"id": "neon-orange", "name": "Orange Neon", "preview": "Orange Neon"},
            {"id": "retro", "name": "Retro", "preview": "Retro"},
            {"id": "retro-vaporwave", "name": "Vaporwave Retro", "preview": "Vaporwave"},
            {"id": "retro-sunset", "name": "Sunset Retro", "preview": "Sunset Retro"},
            {"id": "retro-arcade", "name": "Arcade Retro", "preview": "Arcade Retro"},
            {"id": "emboss", "name": "Embossed", "preview": "Emboss"},
            {"id": "emboss-light", "name": "Light Emboss", "preview": "Light Emboss"},
            {"id": "emboss-heavy", "name": "Heavy Emboss", "preview": "Heavy Emboss"},
            {"id": "emboss-metal", "name": "Metal Emboss", "preview": "Metal Emboss"},
            {"id": "gradient", "name": "Gradient", "preview": "Gradient"},
            {"id": "gradient-sunset", "name": "Sunset Gradient", "preview": "Sunset Gradient"},
            {"id": "gradient-ocean", "name": "Ocean Gradient", "preview": "Ocean Gradient"},
            {"id": "gradient-candy", "name": "Candy Gradient", "preview": "Candy Gradient"},
            {"id": "fire", "name": "Fire", "preview": "Fire"},
            {"id": "fire-blue", "name": "Blue Fire", "preview": "Blue Fire"},
            {"id": "fire-green", "name": "Green Fire", "preview": "Green Fire"},
            {"id": "fire-purple", "name": "Purple Fire", "preview": "Purple Fire"},
            {"id": "comic", "name": "Comic", "preview": "Comic"},
            {"id": "comic-pop", "name": "Pop Comic", "preview": "Pop Comic"},
            {"id": "comic-bam", "name": "Bam Comic", "preview": "Bam Comic"},
            {"id": "comic-zap", "name": "Zap Comic", "preview": "Zap Comic"},
            {"id": "metallic", "name": "Metallic", "preview": "Metal"},
            {"id": "metallic-silver", "name": "Silver Metallic", "preview": "Silver Metal"},
            {"id": "metallic-brass", "name": "Brass Metallic", "preview": "Brass Metal"},
            {"id": "metallic-titanium", "name": "Titanium Metallic", "preview": "Titanium"},
            {"id": "3d", "name": "3D", "preview": "3D Text"},
            {"id": "3d-bold", "name": "Bold 3D", "preview": "Bold 3D"},
            {"id": "3d-float", "name": "Floating 3D", "preview": "Floating 3D"},
            {"id": "3d-deep", "name": "Deep 3D", "preview": "Deep 3D"},
            {"id": "glitch", "name": "Glitch", "preview": "Glitch"},
            {"id": "glitch-cyber", "name": "Cyber Glitch", "preview": "Cyber Glitch"},
            {"id": "glitch-red", "name": "Red Glitch", "preview": "Red Glitch"},
            {"id": "glitch-blue", "name": "Blue Glitch", "preview": "Blue Glitch"},
            {"id": "rainbow", "name": "Rainbow", "preview": "Rainbow"},
            {"id": "rainbow-pastel", "name": "Pastel Rainbow", "preview": "Pastel Rainbow"},
            {"id": "rainbow-vivid", "name": "Vivid Rainbow", "preview": "Vivid Rainbow"},
            {"id": "rainbow-dark", "name": "Dark Rainbow", "preview": "Dark Rainbow"},
            {"id": "chrome", "name": "Chrome", "preview": "Chrome"},
            {"id": "chrome-mirror", "name": "Mirror Chrome", "preview": "Mirror Chrome"},
            {"id": "chrome-dark", "name": "Dark Chrome", "preview": "Dark Chrome"},
            {"id": "chrome-blue", "name": "Blue Chrome", "preview": "Blue Chrome"},
            {"id": "gold", "name": "Gold", "preview": "Gold"},
            {"id": "gold-rose", "name": "Rose Gold", "preview": "Rose Gold"},
            {"id": "gold-antique", "name": "Antique Gold", "preview": "Antique Gold"},
            {"id": "gold-polished", "name": "Polished Gold", "preview": "Polished Gold"},
            {"id": "ice", "name": "Ice", "preview": "Ice"},
            {"id": "ice-frost", "name": "Frost Ice", "preview": "Frost Ice"},
            {"id": "ice-crystal", "name": "Crystal Ice", "preview": "Crystal Ice"},
            {"id": "ice-glacial", "name": "Glacial Ice", "preview": "Glacial Ice"},
            {"id": "neon-pink", "name": "Neon Pink", "preview": "Pink"},
            {"id": "stone", "name": "Stone", "preview": "Stone"},
            {"id": "plasma", "name": "Plasma", "preview": "Plasma"},
            {"id": "vintage", "name": "Vintage", "preview": "Vintage"},
        ...
        .wordart-outline-bold {
            color: #fff;
            
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-outline-double {
            color: #fff;
            text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000,
        ...
        .wordart-emboss-light {
            color: #777;
            text-shadow: -1px -1px 0px #aaa, 1px 1px 0px #333;
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-emboss-heavy {
            color: #555;
            text-shadow: -2px -2px 2px #000, 2px 2px 2px #fff;
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-emboss-metal {
            color: #888;
        ...
        .wordart-gradient-ocean {
            background: linear-gradient(to right, #00ced1, #4682b4, #00008b);
        ...
        .wordart-gradient-candy {
            background: linear-gradient(to right, #ff69b4, #9370db, #00b7eb);
        ...
        .wordart-fire-blue {
            background: linear-gradient(0deg, #00f, #00b7eb);
        ...
        .wordart-fire-green {
            background: linear-gradient(0deg, #0f0, #00ff7f);
        ...
        .wordart-metallic-silver {
            background: linear-gradient(to bottom, #e6e6e6, #a0a0a0);
        ...
        .wordart-metallic-brass {
            background: linear-gradient(to bottom, #e8b923, #b8860b);
        ...
        .wordart-3d-bold {
            color: #ff4500;
            text-shadow: 0px 1px 0px #ff8c00, 0px 2px 0px #ffa500, 0px 3px 0px #ff6347, 0px 4px 0px #ff4500, 0px 5px 10px rgba(0,0,0,0.6);
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-3d-float {
            color: #00ced1;
            text-shadow: 0px 1px 0px #00b7eb, 0px 2px 0px #00b7eb, 0px 3px 0px #00b7eb, 0px 4px 0px #00b7eb, 0px 5px 10px rgba(0,0,0,0.6);
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-3d-deep {
            color: #00008b;
            text-shadow: 0px 1px 0px #0000cd, 0px 2px 0px #0000ff, 0px 3px 0px #1e90ff, 0px 4px 0px #00b7eb, 0px 5px 10px rgba(0,0,0,0.6);
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-glitch {
        ...
        .wordart-rainbow-pastel {
            font-weight: bold;
            font-size: 16px;
            background: linear-gradient(45deg, #ffb6c1, #ffec8b, #90ee90, #add8e6, #d8bfd8);
        ...
        .wordart-rainbow-vivid {
            background: linear-gradient(45deg, #ff0000, #ff4500, #ffff00, #00ff00, #0000ff);
        ...
        .wordart-rainbow-dark {
            background: linear-gradient(45deg, #8b0000, #ff4500, #228b22, #00008b, #4b0082);
        ...
        .wordart-chrome-mirror {
            background: linear-gradient(to bottom, #ffffff, #d3d3d3, #a9a9a9);
        ...
        .wordart-chrome-dark {
            background: linear-gradient(to bottom, #696969, #333, #000);
        ...
        .wordart-chrome-blue {
            background: linear-gradient(to bottom, #87ceeb, #4682b4, #00008b);
        ...
        .wordart-gold-rose {
            background: linear-gradient(to bottom, #ff9999, #ffcc99, #cc9966);
        ...
        .wordart-gold-antique {
            background: linear-gradient(to bottom, #d4a017, #b8860b, #8b6914);
        ...
        .wordart-ice-frost {
            color: #e0ffff;
            text-shadow: 0 0 10px #e0ffff, 0 0 20px #e0ffff, 2px 2px 0px #4682b4;
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-ice-crystal {
            color: #b0e0e6;
            text-shadow: 0 0 10px #b0e0e6, 0 0 20px #b0e0e6, 2px 2px 0px #4682b4;
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-ice-glacial {
            color: #add8e6;
            text-shadow: 0 0 10px #add8e6, 0 0 20px #add8e6, 2px 2px 0px #4682b4;
            font-weight: bold;
            font-size: 16px;
        }
        .wordart-neon-pink {
        ...
        for i, style in enumerate(word_art_styles):
            ...
            # Create a box for the style preview
            style_box = Gtk.Box(orientation=Gtk.Orientation.VERTICAL, spacing=0)
            style_box.set_margin_top(4)
            style_box.set_margin_bottom(4)
            style_box.set_margin_start(4)
            style_box.set_margin_end(4)
    ...
    def _apply_wordart_with_sexlection(self, win, webview, result, input_text, style_id):
        """Apply Word Art using selection if available"""
        try:
            js_result = webview.evaluate_javascript_finish(result)
            selected_text = ""
            ...
            (function() {{
                ...
                switch ('{style_id}') {{
                    ...
                    case 'outline':
                        ...
                        break;
                    case 'outline-bold':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #fff;  font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'outline-double':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #fff; text-shadow: -1px -1px 0 #000, 1px -1px 0 #000, -1px 1px 0 #000, 1px 1px 0 #000, -2px -2px 0 #333, 2px -2px 0 #333, -2px 2px 0 #333, 2px 2px 0 #333; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'outline-neon':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #fff; text-shadow: 0 0 5px #00f, 0 0 10px #00f; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'inset':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; background-color: #666; color: transparent; text-shadow: 2px 2px 3px rgba(255,255,255,0.5); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'inset-soft':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; background-color: #888; color: transparent; text-shadow: 1px 1px 2px rgba(255,255,255,0.3); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'inset-deep':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; background-color: #555; color: transparent; text-shadow: 3px 3px 5px rgba(255,255,255,0.7); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'inset-glow':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; background-color: #666; color: transparent; text-shadow: 0 0 8px rgba(255,255,255,0.5); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'neon':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #fff; text-shadow: 0 0 5px #fff, 0 0 10px #fff, 0 0 15px #0073e6, 0 0 20px #0073e6; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'neon-blue':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #00f; text-shadow: 0 0 5px #00f, 0 0 10px #00f, 0 0 15px #00f; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'neon-green':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #0f0; text-shadow: 0 0 5px #0f0, 0 0 10px #0f0, 0 0 15px #0f0; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'neon-orange':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff4500; text-shadow: 0 0 5px #ff4500, 0 0 10px #ff4500, 0 0 15px #ff4500; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'retro':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #fc0; text-shadow: 2px 2px 0px #f00; font-family: monospace; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'retro-vaporwave':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff69b4; text-shadow: 2px 2px 0px #9400d3; font-family: monospace; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'retro-sunset':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff8c00; text-shadow: 2px 2px 0px #8b008b; font-family: monospace; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'retro-arcade':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #00ff00; text-shadow: 2px 2px 0px #0000ff; font-family: monospace; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'emboss':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #555; text-shadow: -1px -1px 1px #000, 1px 1px 1px #fff; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'emboss-light':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #777; text-shadow: -1px -1px 0px #aaa, 1px 1px 0px #333; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'emboss-heavy':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #555; text-shadow: -2px -2px 2px #000, 2px 2px 2px #fff; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'emboss-metal':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #888; text-shadow: -1px -1px 1px #333, 1px 1px 1px #ccc; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'gradient':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to right, #ff8a00, #e52e71, #2d00f7); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gradient-sunset':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to right, #ff4500, #ff8c00, #ffd700); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gradient-ocean':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to right, #00ced1, #4682b4, #00008b); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gradient-candy':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to right, #ff69b4, #9370db, #00b7eb); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'fire':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(0deg, #ff8c00, #ff0000); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'fire-blue':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(0deg, #00f, #00b7eb); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'fire-green':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(0deg, #0f0, #00ff7f); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'fire-purple':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(0deg, #800080, #ff00ff); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'comic':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #fd0; text-shadow: -3px 0 4px #000; font-family: fantasy, \\'Comic Sans MS\\', cursive; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'comic-pop':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff4500; text-shadow: -3px 0 4px #000; font-family: fantasy, \\'Comic Sans MS\\', cursive; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'comic-bam':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff0000; text-shadow: -3px 0 4px #000; font-family: fantasy, \\'Comic Sans MS\\', cursive; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'comic-zap':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ffff00; text-shadow: -3px 0 4px #000; font-family: fantasy, \\'Comic Sans MS\\', cursive; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'metallic':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #d5d5d5 0%, #919191 98%); color: transparent; text-shadow: 2px 2px 3px rgba(255,255,255,0.5); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'metallic-silver':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #e6e6e6, #a0a0a0); color: transparent; text-shadow: 1px 1px 2px rgba(255,255,255,0.5); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'metallic-brass':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #e8b923, #b8860b); color: transparent; text-shadow: 1px 1px 2px rgba(255,255,255,0.5); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'metallic-titanium':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #c0c0c0, #696969); color: transparent; text-shadow: 1px 1px 2px rgba(255,255,255,0.5); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case '3d':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #5e17eb; text-shadow: 0px 1px 0px #c5bce4, 0px 2px 0px #a197c0, 0px 3px 0px #7c738e, 0px 4px 0px #58505f, 0px 5px 10px rgba(0, 0, 0, 0.6); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case '3d-bold':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff4500; text-shadow: 0px 1px 0px #ff8c00, 0px 2px 0px #ffa500, 0px 3px 0px #ff6347, 0px 4px 0px #ff4500, 0px 5px 10px rgba(0,0,0,0.6); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case '3d-float':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #00ced1; text-shadow: 0px 1px 0px #00b7eb, 0px 2px 0px #00b7eb, 0px 3px 0px #00b7eb, 0px 4px 0px #00b7eb, 0px 5px 10px rgba(0,0,0,0.6); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case '3d-deep':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #00008b; text-shadow: 0px 1px 0px #0000cd, 0px 2px 0px #0000ff, 0px 3px 0px #1e90ff, 0px 4px 0px #00b7eb, 0px 5px 10px rgba(0,0,0,0.6); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'glitch':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #00fffc; text-shadow: 2px 0 #ff00c1, -2px 0 #fffc00; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'glitch-cyber':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #00ff00; text-shadow: 2px 0 #ff00ff, -2px 0 #00ffff; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'glitch-red':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff0000; text-shadow: 2px 0 #00ff00, -2px 0 #0000ff; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'glitch-blue':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #0000ff; text-shadow: 2px 0 #ff0000, -2px 0 #00ff00; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'rainbow':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(45deg, #ff0000, #ff7f00, #ffff00, #00ff00, #0000ff, #4b0082, #9400d3); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'rainbow-pastel':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(45deg, #ffb6c1, #ffec8b, #90ee90, #add8e6, #d8bfd8); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'rainbow-vivid':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(45deg, #ff0000, #ff4500, #ffff00, #00ff00, #0000ff); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'rainbow-dark':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(45deg, #8b0000, #ff4500, #228b22, #00008b, #4b0082); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'chrome':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #eee 0%, #999 50%, #777 51%, #555 100%); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'chrome-mirror':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #ffffff, #d3d3d3, #a9a9a9); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'chrome-dark':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #696969, #333, #000); color: transparent; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'chrome-blue':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #87ceeb, #4682b4, #00008b); color: transparent;  pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gold':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #ffd700 0%, #ffb347 25%, #ff8c00 50%, #ff6347 75%, #b8860b 100%); color: transparent; text-shadow: 2px 2px 4px rgba(0,0,0,0.5); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gold-rose':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #ff9999, #ffcc99, #cc9966); color: transparent; text-shadow: 2px 2px 4px rgba(0,0,0,0.5); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gold-antique':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #d4a017, #b8860b, #8b6914); color: transparent; text-shadow: 2px 2px 4px rgba(0,0,0,0.5); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'gold-polished':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: linear-gradient(to bottom, #fffacd, #ffd700, #b8860b); color: transparent; text-shadow: 2px 2px 4px rgba(0,0,0,0.5); pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'ice':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #87ceeb; text-shadow: 0 0 10px #87ceeb, 0 0 20px #87ceeb, 0 0 30px #87ceeb, 2px 2px 0px #4682b4; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'ice-frost':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #e0ffff; text-shadow: 0 0 10px #e0ffff, 0 0 20px #e0ffff, 2px 2px 0px #4682b4; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'ice-crystal':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #b0e0e6; text-shadow: 0 0 10px #b0e0e6, 0 0 20px #b0e0e6, 2px 2px 0px #4682b4; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'ice-glacial':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #add8e6; text-shadow: 0 0 10px #add8e6, 0 0 20px #add8e6, 2px 2px 0px #4682b4; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'neon-pink':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ff1493; text-shadow: 0 0 5px #ff1493, 0 0 10px #ff1493, 0 0 15px #ff1493, 0 0 20px #ff1493, 0 0 35px #ff1493, 0 0 40px #ff1493; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'stone':
                        ...
                        break;
                    case 'plasma':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; position: relative; font-weight: bold; font-size: 24px;"><span style="position: absolute; top: 0; left: 0; background: radial-gradient(circle, #ff00ff 0%, #00ffff 25%, #ff00ff 50%, #00ffff 75%, #ff00ff 100%); color: transparent; text-shadow: 0 0 10px #ff00ff; pointer-events: none;">{escaped_text}</span><span style="color: transparent; position: relative; z-index: 1;">{escaped_text}</span></span></span>';
                        break;
                    case 'vintage':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #8b4513; text-shadow: 2px 2px 0px #daa520, 4px 4px 0px #cd853f, 6px 6px 10px rgba(0,0,0,0.4); font-family: serif; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'laser':
                        ...
                        break;
                    case 'bubble':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #87ceeb; text-shadow: inset 0 0 10px rgba(255,255,255,0.8); font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
                    case 'electric':
                        wordArtHtml = '<span class="wordart-container" style="display: inline-block; position: relative; white-space: wrap; padding: 0 2px;"><span style="display: inline-block; color: #ffff00; text-shadow: 0 0 5px #ffff00, 0 0 10px #ffff00, 0 0 15px #ffff00, 0 0 20px #ffff00, 2px 2px 0px #ffa500, 4px 4px 0px #ff4500; font-weight: bold; font-size: 24px; position: relative;">{escaped_text}</span></span>';
                        break;
            ...
            win.statusbar.set_text(f"Error applying Word Art: {e}")
######################
    def SVG_BASED_on_wordart_clicked(self, win, btn):
        """Show dialog to select Word Art style"""
        dialog = Adw.Dialog()
        dialog.set_title("Insert Word Art")
        dialog.set_content_width(800)
        ...
        word_art_styles = [
            {
                ...
                <text x="0" y="30" font-size="24" font-weight="bold" fill="url(#grad)">Rainbow</text>
                </svg>
                """
            },
            {
                ...
                "svg": """
                <svg width="160" height="40" xmlns="http://www.w3.org/2000/svg">
                <text x="0" y="30" font-size="24" font-weight="bold" fill="#87ceeb"
                stroke="#4682b4" stroke-width="1">Bubble</text>
                </svg>
                """
            },
            {
                "id": "shadow",
                "name": "Shadow",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#000' style='text-shadow: 4px 4px 8px rgba(0,0,0,0.5);'>Shadow</text></svg>"
            },
            {
                "id": "outline",
                "name": "Outline",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='white' stroke='#000' stroke-width='1'>Outline</text></svg>"
            },
            {
                "id": "inset",
                "name": "Inset",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><rect x='0' y='0' width='160' height='40' fill='#666'/><text x='0' y='30' font-size='24' font-weight='bold' fill='#aaa' style='text-shadow: 2px 2px 3px rgba(255,255,255,0.5);'>Inset</text></svg>"
            },
            {
                "id": "neon",
                "name": "Neon",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#fff' style='text-shadow: 0 0 5px #fff, 0 0 10px #fff, 0 0 15px #0073e6, 0 0 20px #0073e6;'>Neon</text></svg>"
            },
            {
                "id": "retro",
                "name": "Retro",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' font-family='monospace' fill='#fc0' style='text-shadow: 2px 2px 0px #f00;'>Retro</text></svg>"
            },
            {
                "id": "emboss",
                "name": "Emboss",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#555' style='text-shadow: -1px -1px 1px #000, 1px 1px 1px #fff;'>Emboss</text></svg>"
            },
            {
                "id": "gradient",
                "name": "Gradient",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><defs><linearGradient id='grad' x1='0%' y1='0%' x2='100%' y2='0%'><stop offset='0%' stop-color='#e52e71'/><stop offset='100%' stop-color='#ff8a00'/></linearGradient></defs><text x='0' y='30' font-size='24' font-weight='bold' fill='url(#grad)'>Gradient</text></svg>"
            },
            {
                "id": "fire",
                "name": "Fire",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><defs><linearGradient id='grad' x1='0%' y1='0%' x2='100%' y2='0%'><stop offset='0%' stop-color='#ff5500'/><stop offset='100%' stop-color='#ff0000'/></linearGradient></defs><text x='0' y='30' font-size='24' font-weight='bold' fill='url(#grad)' style='text-shadow: 0 0 5px #ff5500;'>Fire</text></svg>"
            },
            {
                "id": "comic",
                "name": "Comic",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' font-family='Comic Sans MS, cursive, fantasy' fill='#fd0' style='text-shadow: -3px 0 4px #000;'>Comic</text></svg>"
            },
            {
                "id": "metallic",
                "name": "Metallic",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#a0a0a0' style='text-shadow: 2px 2px 3px rgba(255,255,255,0.5);'>Metallic</text></svg>"
            },
            {
                "id": "3d",
                "name": "3D",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#5e17eb' style='text-shadow: 0px 1px 0px #c5bce4, 0px 2px 0px #a197c0, 0px 3px 0px #7c738e, 0px 4px 0px #58505f, 0px 5px 10px rgba(0,0,0,0.6);'>3D</text></svg>"
            },
            {
                "id": "glitch",
                "name": "Glitch",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#00fffc' style='text-shadow: 2px 0 #ff00c1, -2px 0 #fffc00;'>Glitch</text></svg>"
            },
            {
                "id": "chrome",
                "name": "Chrome",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#999' style='text-shadow: -1px -1px 0 #333, 1px -1px 0 #333, -1px 1px 0 #333, 1px 1px 0 #333;'>Chrome</text></svg>"
            },
            {
                "id": "gold",
                "name": "Gold",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#ffd700' style='text-shadow: 2px 2px 4px rgba(0,0,0,0.5);'>Gold</text></svg>"
            },
            {
                "id": "ice",
                "name": "Ice",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#87ceeb' style='text-shadow: 0 0 10px #87ceeb, 0 0 20px #87ceeb, 2px 2px 0px #4682b4;'>Ice</text></svg>"
            },
            {
                "id": "neon-pink",
                "name": "Neon Pink",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#ff1493' style='text-shadow: 0 0 5px #ff1493, 0 0 10px #ff1493, 0 0 15px #ff1493, 0 0 20px #ff1493;'>Neon Pink</text></svg>"
            },
            {
                "id": "stone",
                "name": "Stone",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#8b7355' style='text-shadow: 1px 1px 0px #a0522d, 2px 2px 0px #8b4513, 3px 3px 0px #654321, 4px 4px 8px rgba(0,0,0,0.6);'>Stone</text></svg>"
            },
            {
                "id": "plasma",
                "name": "Plasma",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#ff00ff' style='text-shadow: 0 0 10px #ff00ff;'>Plasma</text></svg>"
            },
            {
                "id": "vintage",
                "name": "Vintage",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' font-family='serif' fill='#8b4513' style='text-shadow: 2px 2px 0px #daa520, 4px 4px 0px #cd853f, 6px 6px 10px rgba(0,0,0,0.4);'>Vintage</text></svg>"
            },
            {
                "id": "laser",
                "name": "Laser",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' font-family='monospace' fill='#00ff00' style='text-shadow: 0 0 5px #00ff00, 0 0 10px #00ff00, 0 0 15px #00ff00, 0 0 20px #00ff00;'>Laser</text></svg>"
            },
            {
                "id": "electric",
                "name": "Electric",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#ffff00' style='text-shadow: 0 0 5px #ffff00, 0 0 10px #ffff00, 2px 2px 0px #ffa500, 4px 4px 0px #ff4500;'>Electric</text></svg>"
            },
            {
                "id": "bold-blue",
                "name": "Bold Blue",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#1e3a8a' style='text-shadow: 2px 2px 4px rgba(30, 58, 138, 0.3);'>Bold Blue</text></svg>"
            },
            {
                "id": "royal-purple",
                "name": "Royal Purple",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#6b21a8' style='text-shadow: 2px 2px 6px rgba(107, 33, 168, 0.4);'>Royal Purple</text></svg>"
            },
            {
                "id": "deep-red",
                "name": "Deep Red",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#dc2626' style='text-shadow: 2px 2px 4px rgba(220, 38, 38, 0.3);'>Deep Red</text></svg>"
            },
            {
                "id": "forest-green",
                "name": "Forest Green",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#166534' style='text-shadow: 2px 2px 4px rgba(22, 101, 52, 0.3);'>Forest Green</text></svg>"
            },
            {
                "id": "copper",
                "name": "Copper",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#b45309' style='text-shadow: 1px 1px 2px rgba(180, 83, 9, 0.4), 2px 2px 4px rgba(180, 83, 9, 0.2);'>Copper</text></svg>"
            },
            {
                "id": "navy-shadow",
                "name": "Navy Shadow",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#1e40af' style='text-shadow: 3px 3px 6px rgba(30, 64, 175, 0.5);'>Navy Shadow</text></svg>"
            },
            {
                "id": "burgundy",
                "name": "Burgundy",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#991b1b' style='text-shadow: 2px 2px 4px rgba(153, 27, 27, 0.4);'>Burgundy</text></svg>"
            },
            {
                "id": "teal-glow",
                "name": "Teal Glow",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#0f766e' style='text-shadow: 0 0 8px rgba(15, 118, 110, 0.6), 2px 2px 4px rgba(15, 118, 110, 0.3);'>Teal Glow</text></svg>"
            },
            {
                "id": "chocolate",
                "name": "Chocolate",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#92400e' style='text-shadow: 2px 2px 4px rgba(146, 64, 14, 0.4);'>Chocolate</text></svg>"
            },
            {
                "id": "steel-blue",
                "name": "Steel Blue",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#0369a1' style='text-shadow: 2px 2px 5px rgba(3, 105, 161, 0.4);'>Steel Blue</text></svg>"
            },
            {
                "id": "crimson",
                "name": "Crimson",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#be123c' style='text-shadow: 2px 2px 4px rgba(190, 18, 60, 0.4);'>Crimson</text></svg>"
            },
            {
                "id": "emerald",
                "name": "Emerald",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#047857' style='text-shadow: 2px 2px 4px rgba(4, 120, 87, 0.4);'>Emerald</text></svg>"
            },
            {
                "id": "bronze",
                "name": "Bronze",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#a16207' style='text-shadow: 1px 1px 2px rgba(161, 98, 7, 0.4), 2px 2px 4px rgba(161, 98, 7, 0.2);'>Bronze</text></svg>"
            },
            {
                "id": "indigo",
                "name": "Indigo",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#4338ca' style='text-shadow: 2px 2px 5px rgba(67, 56, 202, 0.4);'>Indigo</text></svg>"
            },
            {
                "id": "maroon",
                "name": "Maroon",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#881337' style='text-shadow: 2px 2px 4px rgba(136, 19, 55, 0.4);'>Maroon</text></svg>"
            },
            {
                "id": "olive",
                "name": "Olive",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#365314' style='text-shadow: 2px 2px 4px rgba(54, 83, 20, 0.4);'>Olive</text></svg>"
            },
            {
                "id": "slate",
                "name": "Slate",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#334155' style='text-shadow: 2px 2px 4px rgba(51, 65, 85, 0.4);'>Slate</text></svg>"
            },
            {
                "id": "rust",
                "name": "Rust",
                "svg": "<svg width='160' height='40' xmlns='http://www.w3.org/2000/svg'><text x='0' y='30' font-size='24' font-weight='bold' fill='#c2410c' style='text-shadow: 2px 2px 4px rgba(194, 65, 12, 0.4);'>Rust</text></svg>"
            },
        ]
        ...
        for i, style in enumerate(word_art_styles):
            ...
            svg_bytes = style["svg"].encode("utf-8")
